...
MISSION_CONTROL_URL=http://localhost:17789
```
...
Visit [http://localhost:17789](http://localhost:17789)
...
WORKSPACE_BASE_PATH=~/Documents/Shared
PROJECTS_PATH=~/Documents/Shared/projects
MISSION_CONTROL_URL=http://your-server-ip:17789
OPENCLAW_GATEWAY_URL=ws://127.0.0.1:18789
```
...
2. Open Mission Control: `http://localhost:17789`
