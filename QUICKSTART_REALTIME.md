...
await fetch(`http://localhost:17789/api/tasks/${taskId}/activities`, {
  method: 'POST',
...
```typescript
await fetch(`http://localhost:17789/api/tasks/${taskId}/deliverables`, {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
await fetch(`http://localhost:17789/api/tasks/${taskId}/subagent`, {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
1. **Open two browser windows:**
   - Window 1: http://localhost:17789
   - Window 2: http://localhost:17789
